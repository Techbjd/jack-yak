...
export default function MapQuote() {
    return (
        <div className="flex w-full justify-center px-6 md:px-0">
            <p className={`${fontPrimary} w-full max-w-quote text-center text-xl leading-[1.3] font-medium text-text-primary sm:text-2xl md:text-3xl md:leading-11 lg:text-2xl-3xl`}>
