...
export const headingSection =
    'font-manrope text-lg-xl leading-display-tight font-bold text-text-primary uppercase md:text-3xl-4xl';

export const headingSubsection =
    'font-manrope text-xl-2xl leading-display-tight font-bold text-text-primary md:text-3xl-4xl';

export const bodyText =
    'font-manrope text-sm-base leading-display-tight font-normal text-text-primary md:text-xl-2xl';

export const bodyTextSmall =
    'font-manrope text-sm-base leading-display-tight font-normal text-text-primary';

export const ctaMobile =
    'font-manrope flex h-6.25 w-fit items-center justify-center gap-2 rounded-full bg-cta-accent px-3 text-xs-sm leading-4 font-bold text-white';

export const ctaDesktop =
    'font-manrope hidden h-10.5 w-fit items-center justify-center gap-2 rounded-full bg-cta px-3 text-md-lg leading-itinerary-22 font-bold text-white md:flex';
...
export const cardMobileContent = 'h-9.25 w-card-w';
...
export const authInput =
    'font-manrope h-9.5 w-full rounded-auth border border-frost-line bg-white px-3 text-xs font-bold text-ink outline-none placeholder:text-fog focus:border-ink lg:bg-frost';

export const authButton =
    'font-manrope flex h-9.5 w-full items-center justify-center rounded-auth bg-pine text-sm font-bold text-white';

export const authSocialButton =
    'font-manrope flex h-9.5 w-full items-center justify-center gap-2.5 rounded-auth border border-frost-line bg-white text-xs font-bold text-ink lg:bg-frost';
...
export const quizLabel =
    'font-manrope text-sm-md leading-5 font-medium text-midnight';

export const quizInput =
    'font-manrope h-11.75 w-full rounded-md border border-quiz-line bg-white px-4 text-sm-md font-medium text-midnight outline-none placeholder:text-mist focus:border-midnight';
...
export const userEditButton =
    'font-manrope flex h-7.25 w-33.5 items-center justify-center gap-2 rounded-md bg-cta-accent text-xs-sm font-medium text-white md:h-14 md:w-61.5 md:gap-3 md:bg-cta md:text-lg-xl';
...
export const itinPage =
    'font-manrope mx-auto flex w-full max-w-full flex-col bg-canvas px-2.5 pb-10 md:max-w-container md:px-12 md:pb-16 lg:px-24';
...
export const itinDayCard =
    'rounded-itinerary-card flex min-h-day-card-h snap-start items-center gap-2.5 bg-white p-2 pl-3 shadow-card min-[360px]:gap-3.5 min-[360px]:p-2.5 min-[360px]:pl-4 md:h-auto md:min-h-day-card-desktop-h md:snap-align-none md:gap-4 md:p-1 md:shadow-none md:ring-1 md:ring-line-soft';

export const itinDayThumb =
    'rounded-itinerary-thumb h-[84px] w-[84px] shrink-0 object-cover min-[360px]:h-day-thumb-h min-[360px]:w-day-thumb-w md:h-day-thumb-desktop-h md:w-day-thumb-desktop-w md:rounded-itinerary-card';
